            ...
            .StartAsync("Processing request...", async ctx => 
            {
                return await mediator.Send(new CreateSubscriptionRequest(argument.TopicName, argument.Name, argument.Description, argument.WebhookUrl, argument.EventTypeIds, argument.MaxDeliveryAttempts))
                    ...
                    .Match(
                        success =>
                        {
                            BaseCommands.DisplaySuccessCommand("Subscription", BaseCommands.CommandAction.Create, console);
                        ...
                        error =>
                        {
                            BaseCommands.DisplayErrorCommand("Subscription", BaseCommands.CommandAction.Create, error.Message, console);
