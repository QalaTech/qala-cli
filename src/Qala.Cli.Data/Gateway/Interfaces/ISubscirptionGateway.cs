...
public interface ISubscriptionGateway
{
    ...
    Task<Subscription?> UpdateSubscriptionAsync(string topicType, string topicName, Guid subscriptionId, string name, string description, string webhookUrl, List<Guid> eventTypeIds, int maxDeliveryAttempts);
